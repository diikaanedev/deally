...
class AdresseScreenRetailerWidget extends StatefulWidget {
  ...
  @override
  _AdresseScreenRetailerWidgetState createState() =>
      _AdresseScreenRetailerWidgetState();
}

class _AdresseScreenRetailerWidgetState
    extends State<AdresseScreenRetailerWidget> {
  late Size size;
                                    ...
                                    child: Column(
                                      children: [
                                        SizedBox(
                                          ...
                                          child: AdresseItemScreenRetailerWidget(
                                              adresse: e,
                          ...
                          onTap: () {
                            ...
                            showCupertinoModalBottomSheet(
                                ...
                                builder: (context) => SizedBox(
                                    ...
                                    child: const AddAdresseScreenRetailer()));
                          },
                          child: Container(
                            width: size.width * .9,
