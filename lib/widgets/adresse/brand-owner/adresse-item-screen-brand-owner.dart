...
import 'package:deally/widgets/adresse/brand-owner/edit-adresse-screen-brand-owner.dart';
...
class AdresseItemScreenBrandOwnerWidget extends StatefulWidget {
  final AdresseModel adresse;
  final String asset_url;

  const AdresseItemScreenBrandOwnerWidget({
    Key? key,
  ...
  @override
  _AdresseItemScreenBrandOwnerWidgetState createState() =>
      _AdresseItemScreenBrandOwnerWidgetState();
}

class _AdresseItemScreenBrandOwnerWidgetState
    extends State<AdresseItemScreenBrandOwnerWidget> {
  @override
                                  ...
                                  showCupertinoModalBottomSheet(
                                      ...
                                      builder: (context) => SizedBox(
                                          height: MediaQuery.of(context)
                                                  ...
                                                  .height *
                                              .7,
                                          child: EditAddressScreenBrandOwner(
