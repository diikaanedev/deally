...
class EditAddressScreenBrandOwner extends StatefulWidget {
  final AdresseModel address;
  const EditAddressScreenBrandOwner({Key? key, required this.address})
      : super(key: key);

  @override
  _EditAddressScreenBrandOwnerState createState() =>
      _EditAddressScreenBrandOwnerState();
}

class _EditAddressScreenBrandOwnerState
    extends State<EditAddressScreenBrandOwner> {
  late Size size;
