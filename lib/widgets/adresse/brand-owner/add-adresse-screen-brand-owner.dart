...
class AddAdresseScreenBrandOwner extends StatefulWidget {
  const AddAdresseScreenBrandOwner({Key? key}) : super(key: key);

  @override
  _AddAdresseScreenBrandOwnerState createState() =>
      _AddAdresseScreenBrandOwnerState();
}

class _AddAdresseScreenBrandOwnerState
    extends State<AddAdresseScreenBrandOwner> {
  late Size size;
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          homeBrandOwnerState.langue == 1 ? 'Last Name' : 'Nom',
                      hintStyle: TextStyle(
                          fontWeight: FontWeight.w300,
              ...
              child: Container(
                ...
                child: Padding(
                  ...
                  child: TextFormField(
                    ...
                    style: TextStyle(fontSize: size.height * .02),
                    decoration: InputDecoration(
                      hintText: homeBrandOwnerState.langue == 1
                          ? 'Firts Name'
                          : 'Prénom',
                      hintStyle: TextStyle(
                          fontWeight: FontWeight.w300,
