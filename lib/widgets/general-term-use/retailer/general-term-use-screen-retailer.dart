...
class GeneralTermUseRetailer extends StatefulWidget {
  final String title;
  const GeneralTermUseRetailer(
      {Key? key, this.title = "Conditions Générales d'Utilisation "})
      : super(key: key);

  @override
  _GeneralTermUseRetailerState createState() => _GeneralTermUseRetailerState();
}

class _GeneralTermUseRetailerState extends State<GeneralTermUseRetailer> {
  late Size size;
  @override
